<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('clientes') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg">
                Agregar Cliente
            </a>
        </div>
    </x-slot>
                ...
                <table class="min-w-full bg-gray-800 text-gray-100 rounded-lg shadow-lg">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm">
                                <button class="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg">Editar</button>
                                <button class="bg-red-600 hover:bg-red-500 text-white px-4 py-2 rounded-lg">Eliminar</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
